    ...
    $.supersized = function(options){
		...
		base.nextSlide = function(){
			...
			if (!$(targetList).html()){
				...
				img.appendTo(targetList).wrap('<a ' + imageLink + linkTarget + '></a>').parent().parent().addClass('image-loading').css('visibility','visible');
		    ...
		    nextslide.css('visibility','visible').addClass('activeslide');	// Update active slide
	    	...
	    	switch(base.options.transition){
	    		...
	    		case 7: case 'carouselLeft':   // Carousel Left
					...
					liveslide.animate({ left: base.$el.width(), avoidTransforms : false }, base.options.transition_speed );
	    			break;
	    		case 8: case 'carouselBottom':   // Carousel Left
	    			nextslide.animate({top : base.$el.height()}, 0 ).css('visibility','visible').animate({ top:0, avoidTransforms : false }, base.options.transition_speed, function(){ base.afterAnimation(); });
		...
		base.prevSlide = function(){
		    ...
		    switch(base.options.transition){
	    		...
	    		case 7: case 'carouselLeft':   // Carousel Left (reverse)
					...
					liveslide.animate({left : 0}, 0 ).animate({ left: -base.$el.width(), avoidTransforms : false }, base.options.transition_speed );
	    			break;
	    		case 8: case 'carouselBottom':   // Carousel Bottom (reverse)
	    			nextslide.animate({top : -base.$el.height()}, 0 ).css('visibility','visible').animate({ top:0, avoidTransforms : false }, base.options.transition_speed, function(){ base.afterAnimation(); });
					liveslide.animate({top : 0}, 0 ).animate({ top: base.$el.height(), avoidTransforms : false }, base.options.transition_speed );
	    			break;
	    	}
		    return false;	
		};
